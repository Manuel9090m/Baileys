...
```
yarn add @braylerdarkvip/baileys
```
...
``` ts 
import makeWASocket from '@braylerdarkvip/baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from '@braylerdarkvip/baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from '@darkkey/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@darkkey/baileys'
...
const templateButtons = [
    {index: 1, urlButton: {displayText: '⭐ Star Baileys on GitHub!', url: 'https://github.com/darkkey/Baileys'}},
...
``` ts
// send a link
const sentMsg  = await sock.sendMessage(id, { text: 'Hi, this was sent using https://github.com/darkkey/baileys' })
```
...
``` ts
import { MessageType, MessageOptions, Mimetype } from '@braylerdarkvip/baileys'
// Sending gifs
...
const templateButtons = [
  {index: 1, urlButton: {displayText: '⭐ Star Baileys on GitHub!', url: 'https://github.com/braylerdarkvip/baileys'}},
  {index: 2, callButton: {displayText: 'Call me!', phoneNumber: '+1 (234) 5678-901'}},
  {index: 3, quickReplyButton: {displayText: 'This is a reply, just like normal buttons!', id: 'id-like-buttons-message'}},
]
...
import { downloadMediaMessage } from '@darkkey/baileys'
